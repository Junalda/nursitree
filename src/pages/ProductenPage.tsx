...
De natuurlijke verspreiding zorgt ervoor dat de bollen zich in de kweekperiode gaan vermeerderen. Bij het verplanten van de boom worden alle bollen meegenomen, wat op de nieuwe locatie ook voor een biodiversiteitstoevoeging zorgt.`;
  ...
  const partlyText = `Topcover ‘Partly’ is geschikt voor locaties met bovengronds meer ruimte dan bij ‘Full’. In deze situaties is de boomspiegel groter en wordt meer onderbeplanting toegepast. Ook bij deze plaat is een standaardafwerking én maatwerk mogelijk.`;

...
const HERO_IMG = 'https://d64gsuwffb70l.cloudfront.net/69cd2e1dc76c2b3ecc191d41_1775071012857_bd6cbbee.jpg';
const ZwhHero: React.FC = () => {
  ...
  const scrollToProduct = () => {
    const el = document.getElementById('zwh-product');
    el?.scrollIntoView({
      behavior: 'smooth'
    });
  };
  const scrollToFaq = () => {
    const el = document.getElementById('zwh-faq');
    el?.scrollIntoView({
      behavior: 'smooth'
    });
  };
  return <section className="relative min-h-[85vh] sm:min-h-[92vh] flex items-center overflow-hidden bg-white">
      {/* Subtle background accents — matching homepage */}
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-gray-900 leading-[1.08] tracking-tight mb-5 sm:mb-8">
              De slimme
              <br />
              <span className="text-[#E8854A]">groeiplaats</span>
              <br />
              in de stad
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <button onClick={scrollToFaq} className="px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-gray-200 text-gray-700 text-sm sm:text-base font-semibold rounded-xl hover:border-[#E8854A] hover:text-[#E8854A] transition-all duration-200 flex items-center justify-center gap-2">
                Veelgestelde vragen
              </button>
            </div>
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="https://d64gsuwffb70l.cloudfront.net/682e0896b7c1872af32988f8_1776926850063_18f70b16.jpg" alt="Urban tree pit in modern city" className="w-full h-[280px] sm:h-[350px] md:h-[400px] lg:h-[520px] object-cover" />
            ...
            <div className="absolute -top-4 -right-4 bg-[#E8854A] rounded-xl shadow-xl p-4 border border-[#E8854A] hidden md:block animate-float-slow">
              <div className="flex items-center gap-3">
                <div>
                  <div className="text-xl font-bold text-white">BRENT</div>
                  <div className="text-xs text-white/80">Urban Tree Pit</div>
                </div>
              </div>
            </div>
